		...
		<div class="container pagecontainer offset-0">	
			...
			<div class="col-md-8 details-slider">
				...
				<div class="wh80percent center">
					<img src="updates/update1/img/car.jpg" class="fwimg" alt=""/>
				</div>
			...
			<div class="col-md-4 detailsright offset-0">
				<div class="padding20">
					<div class="wh70percent left">
						<span class="opensans size18 dark bold">Mercedes C220</span><br/>
						<span class="opensans size13 grey bold">Luxury</span>
					</div>
					<div class="wh30percent right">
						<table class="right">
							<tr>
								<td><span class="size12 lgrey"><i>per day</i></span></td>
								<td><span class="size14 grey bold">$40.00</span></td>
							</tr>
							<tr>
				...
				<div class="padding20">
					...
					<span class="size24 green bold right margtop-5">$258.00</span>
				...
				<div class="hpadding20">
					<a href="#" class="booknow margtop20 btnmarg">Book now</a><br/>
				</div>
			</div>
			<!-- END OF RIGHT INFO -->
