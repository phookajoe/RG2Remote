		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-8 pagecontainer2 offset-0">
				...
				<div class="padding30 grey">
					<span class="size16px bold dark left">Your contact information </span>
				...
				<div class="pagecontainer2 paymentbox grey">
					<div class="padding30">
						...
						<div class="wh30percent left">
							<img src="updates/update1/img/activities/act02.jpg" width="100" class="fwimg margright20" alt=""/>
						</div>
						<div class="wh60percent mt-10 right">
							<span class="opensans size18 dark bold">Aquaventure Waterpark and The Lost Chambers Aquarium</span><br/>
							<span class="opensans size13 grey">U.A.E. Dubai</span><br/>
					...
					<span class="size12 grey2">
						2 Person over 42 inches <span class="right bold">$160.00</span>
					</span>
					<div class="fdash mt10"></div><br/><br/>
					
					</div>	
					<div class="line3"></div>
					<div class="padding30">					
						<span class="left size14 dark">Trip Total:</span>
						<span class="right lred2 bold size18">$160.00</span>
						<div class="clearfix"></div>
					</div>
