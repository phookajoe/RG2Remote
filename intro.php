  ...
  <body>
	...
	<div class="bluediv">
		...
		<div class="tabscontainer">
			<ul class='tabs'>
				<li class="b1" onclick='mySelectUpdate();'><a href='#tab1'><div class="anivacations"><img src="images/spacer.png" alt=""/>Vacations</div></a></li>
				<li class="b2" onclick='mySelectUpdate();'><a href='#tab2'><div class="anihotels"><img src="images/spacer.png" alt=""/>Hotels</div></a></li>
				<li class="b3" onclick='mySelectUpdate();'><a href='#tab3'><div class="aniflights"><img src="images/spacer.png" alt=""/>Flights</div></a></li>
				<li class="b4" onclick='mySelectUpdate();'><a href='#tab4'><div class="anicars"><img src="images/spacer.png" alt=""/>Cars</div></a></li>
				<li class="b5" onclick='mySelectUpdate();'><a href='#tab5'><div class="anicruises"><img src="images/spacer.png" alt=""/>Cruises</div></a></li>
			</ul>
		</div>
    ...
    <!-- Javascript -->
	<script src="assets/js/js-intro.js"></script>
