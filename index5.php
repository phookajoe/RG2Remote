		  ...
		  <div class="row">
			...
			<div class="col-md-4">
				<div class="shadow cstyle05">
					<div class="fwi one"><img src="images/rome.jpg" alt="" /><div class="mhover none"><span class="icon"><a href="list.php"><img src="images/spacer.png" alt=""/></a></span></div></div>
					<div class="ctitle">Rome<a href="list.php"><img src="images/spacer.png" alt=""/></a>
						<span>$59.99</span>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="shadow cstyle05">
					<div class="fwi one"><img src="images/surfer.jpg" alt="" /><div class="mhover none"><span class="icon"><a href="list3.php"><img src="images/spacer.png" alt=""/></a></span></div></div>
					<div class="ctitle">Cote d'azur<a href="list3.php"><img src="images/spacer.png" alt=""/></a>
						<span>$59.99</span>
					</div>
				</div>			
			</div>
		...
		<div class="container cstyle07">	
			  ...
			  <div class="col-md-4">
				<div class="boxshadow center">
					<a href="list4.php"><img src="images/botswana.jpg" alt="" class="fwimg"/></a>
			  ...
			  <div class="col-md-4">
				<div class="boxshadow center">
					<a href="list4.php"><img src="images/egypt.jpg" alt="" class="fwimg"/>	</a>		
					<div class="bscontainer">
						<h4 class="lato bold caps">Lorem ipsum dolor sit amet, consectetur</h4>
						<hr>
						<p class="textleft grey">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis enim et mauris bibendum lobortis eget non eros. Nulla facilisi. Nulla facilisi.</p>
			  ...
			  <div class="col-md-4">
				<div class="boxshadow center">
					<a href="list4.php"><img src="images/machu_picchu.jpg" alt="" class="fwimg"/></a>		
					<div class="bscontainer">
						<h4 class="lato bold caps">Lorem ipsum dolor sit amet, consectetur</h4>
						<hr>
						<p class="textleft grey">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In quis enim et mauris bibendum lobortis eget non eros. Nulla facilisi. Nulla facilisi.</p>
