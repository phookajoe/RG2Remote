			...
			<div class="col-md-12 pagecontainer2 offset-0">
				...
				<div class="hpadding50c">
					...
					<div class="col-md-8 cpdd01 grey2">
						<div class="abover">
							<div class="abbg">
								<a href="images/about-man.jpg" class="blogpost-hover" data-footer="A custom footer text" data-title="A random title" data-gallery="multiimages" data-toggle="lightbox"><span class="glyphicon glyphicon-zoom-in"></span></a>
							</div>
						...
						<br/><br/>
						<button onclick="errorMessage()" type="submit" class="btn-search5">Read more <span class="glyphicon glyphicon-arrow-right"></span></button>
						<br/><br/>
						...
						<div class="wrapper2">
							<div class="list_carousel2">
								<ul id="foo5">
									<li>
										<a href="#"><img src="images/details-slider/slide1.jpg" alt=""/></a>
										<div class="m1">
									...
									<li>
										<a href="#"><img src="images/details-slider/slide2.jpg" alt=""/></a>
										<div class="m1">
									...
									<li>
										<a href="#"><img src="images/details-slider/slide3.jpg" alt=""/></a>
										<div class="m1">
								...
								<div class="clearfix"></div>
								<a id="prev_btn" class="xprev" href="#"><img src="images/spacer.png" alt=""/></a>
								<a id="next_btn" class="xnext" href="#"><img src="images/spacer.png" alt=""/></a>
							</div>
						</div>
						
						<br/>
						<span class="lato size22 dark bold">Image Gallery slider</span><br/>
						<span class="grey">December 25, 2013/<a href="#">0 Comments</a>/in <a href="#">Vacations</a>/by <a href="#">TitanicThemes</a></span><br/>
						<div class="line4"></div>
						Donec vehicula nunc in turpis rutrum porta. Nullam lacinia ante non turpis aliquam mattis. Pellentesque luctus leo eget metus egestas egestas. Maecenas hendrerit magna ut porttitor tempor. In hac habitasse platea dictumst. Duis condimentum congue nisi, ac semper ipsum posuere eu. 
						<br/><br/>
						...
						<div class="abover-off">
							<div class="abbg-off">
								<a href="http://www.youtube.com/watch?v=6NSnyZaVt_E" class="blogpost-hover2"  data-gallery="youtubevideos" data-toggle="lightbox"><span class="glyphicon glyphicon-play"></span></a>
							</div>
							<img src="images/basejump.jpg" class="fwimg" alt=""/>
						</div><br/>
						<span class="lato size22 dark bold">Greece - Zakynthos / Navagio Beach base Jumps video</span><br/>
						<span class="grey">December 25, 2013/<a href="#">0 Comments</a>/in <a href="#">Vacations</a>/by <a href="#">TitanicThemes</a></span><br/>
						<div class="line4"></div>
						Donec vehicula nunc in turpis rutrum porta. Nullam lacinia ante non turpis aliquam mattis. Pellentesque luctus leo eget metus egestas egestas. Maecenas hendrerit magna ut porttitor tempor. In hac habitasse platea dictumst. Duis condimentum congue nisi, ac semper ipsum posuere eu. 
						<br/><br/>
						...
						<div class="abover">
							<div class="abbg-off">
								<a href="#" class="blogpost-hover"><span class="glyphicon glyphicon-heart"></span></a>
							</div>
							<img src="images/test.jpg" class="fwimg" alt=""/>
						</div><br/>
						<span class="lato size22 dark bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span><br/>
						<span class="grey">December 25, 2013/<a href="#">0 Comments</a>/in <a href="#">Vacations</a>/by <a href="#">TitanicThemes</a></span><br/>
						<div class="line4"></div>
