			  ...
			  <div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
				  <li class="dropdown active">
					<a data-toggle="dropdown" class="dropdown-toggle" href="index.php">Home <span class="badge indent0">1</span><b class="lightcaret mt-2"></b></a>
					  ...
					  <li>
							<div class="row dropwidth01">
								...
								<ul class="droplist col-md-4">
								  ...
								  <li><a href="intro3.php">Intro 3 - slides2</a> <span class="glyphicon glyphicon-star lblue"></span></li>
								</ul>
								<ul class="droplist col-md-4">
								  <li class="dropdown-header">Colors</li>
								  <li><a href="../blue/index.php">Blue</a></li>
								  <li><a href="../green/index.php">Green</a></li>
								  <li><a href="../orange/index.php">Orange</a></li>
								  <li><a href="../cyan/index.php">Cyan</a></li>
								  <li></li>
				  ...
				  <li class="dropdown">
					...
					<ul class="dropdown-menu posright-0">
					  <li>
							<div class="row dropwidth01">
								<ul class="droplist col-md-4">
								  <li class="dropdown-header">Inner pages 02</li>	
					...
					<div class="topsortby">
						...
						<div class="col-md-4 offset-0">
							...
							<div class="right">
								...
								<button class="listbtn" onClick="window.open('list4.php','_self');">&nbsp;</button>
