			...
			<div class="col-md-12 pagecontainer2 offset-0">
				...
				<div class="hpadding50c">
					...
					<div class="col-md-8 cpdd01 grey2">
						...
						<span class="size14 dark bold">Response to this project</span>
						<div class="line4"></div>
						<textarea class="form-control" rows="3"></textarea><br/>
						
						<button onclick="errorMessage()" type="submit" class="btn-search5">Post <span class="glyphicon glyphicon-arrow-down"></span></button>
						<br/><br/><br/>
						...
						<div class="wh90percent right">
								<div class="wh20percent left textleft">
									...
									<span class="glyphicon glyphicon-share-alt cpdl"></span>
									</div>
								</div>
								<div class="wh80percent right">
									<a href="#" class="lblue bold">Ana</a><br/>
									Maecenas hendrerit magna ut porttitor tempor. In hac habitasse platea dictumst. Duis condimentum congue nisi, ac semper ipsum posuere eu. 
									<br/><span class="grey size12">2 minutes ago | <a href="#" class="grey">Reply</a></span>									
								</div>
								<div class="clearfix"></div>
						</div>
						<div class="clearfix"></div>
						...
						<div class="wh80percent right">
							<a href="#" class="lblue bold">Michael</a><br/>
							Maecenas hendrerit magna ut porttitor tempor. In hac habitasse platea dictumst. Duis condimentum congue nisi, ac semper ipsum posuere eu. 
							<br/><span class="grey size12">3 days ago | <a href="#" class="grey">Reply</a></span>							
						</div>
						<div class="clearfix"></div>
						<div class="line4"></div>			
						...
						<div class="wh80percent right">
							<a href="#" class="lblue bold">Andrew Michaelson</a><br/>
							Maecenas hendrerit magna ut porttitor tempor. In hac habitasse platea dictumst. Duis condimentum congue nisi, ac semper ipsum posuere eu. 
							<br/><span class="grey size12">3 days ago | <a href="#" class="grey">Reply</a></span>							
						</div>
						<div class="clearfix"></div>
						...
						<div class="wh80percent right">
							<a href="#" class="lblue bold">George</a><br/>
							Maecenas hendrerit magna ut porttitor tempor. In hac habitasse platea dictumst. Duis condimentum congue nisi, ac semper ipsum posuere eu. 
							<br/><span class="grey size12">3 days ago | <a href="#" class="grey">Reply</a></span>							
						</div>
						<div class="clearfix"></div>
