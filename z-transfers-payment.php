		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-8 pagecontainer2 offset-0">
				...
				<div class="padding30 grey">
					...
					<br/>
					<div class="col-md-4 textright">
						<div class="margtop7"><span class="dark">Flight arrival time</span><span class="red">*</span></div>
					</div>
					<div class="col-md-4">
					...
					<br/>
					<div class="col-md-4 textright">
						<div class="margtop15"><span class="dark">Company & flight number</span><span class="red">*</span></div>
					</div>
					<div class="col-md-4">
					...
					<br/>
					<div class="col-md-4 textright">
						<div class="margtop15"><span class="dark">Flight arriving from</span><span class="red">*</span></div>
					</div>
					<div class="col-md-4">
						<input type="text" class="form-control mt10" placeholder="">
					</div>
				...
				<div class="pagecontainer2 paymentbox grey">
					...
					<div>
						...
						<div class="wh33percent left size12 grey">
							United Kingdom - London City (LCY)<br/>
							04:05 PM
						</div>
						<div class="wh33percent right textright size12 grey">
							Resort/City Information - CAMBRIDGE<br/>
							07:35 PM
						</div>
						<div class="clearfix"></div>
					</div>
